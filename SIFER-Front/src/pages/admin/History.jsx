  ...
  const [history, setHistory] = useState([
    {
      ...
      quantity: 3,
      total: 150,
      datetime: "2024-11-29 10:00",
    },
    {
      employee: "Rogelio Guzman",
      code: "P002",
      quantity: 5,
      total: 250,
      datetime: "2024-11-28 15:30",
    },
    {
      employee: "Cecilia Rojas",
      code: "P003",
      quantity: 2,
      total: 100,
      datetime: "2024-11-27 12:45",
    },
    {
      employee: "Alejandra Ortiz",
      code: "P004",
      quantity: 4,
      total: 200,
      datetime: "2024-11-26 09:20",
    },
    {
      employee: "Minerva Duran",
      code: "P005",
      quantity: 1,
      total: 50,
      datetime: "2024-11-25 11:10",
    },
  ]);
  ...
  return (
    <>
      ...
      <div className="container mt-5">
        ...
        <h3 className="text-dark mt-5 mb-5">
          aqui podemos poner el dia traido dinamicamente o no c
        </h3>
