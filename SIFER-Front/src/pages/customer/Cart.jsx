      ...
      <div className="container" style={{ marginTop: 90 }}>
        ...
        <div className="row mt-2">
          {filteredProducts.map((product, index) => (
            <div key={product.name} className="col-md-6 mb-4">
              {" "}
              {/* col-md-6 para crear 2 columnas por fila */}
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="card-body d-flex flex-column flex-grow-1 ms-3">
                    ...
                    <div className="d-flex text-center align-items-center">
                      <label className="fw-medium me-2 text-center align-items-center">
                        Cantidad:
                      </label>
                      <input
                        type="number"
                        ...
                        className="form-control align-content-center border shadow border-secondary-subtle "
