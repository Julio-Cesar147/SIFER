        ...
        <div className="container d-flex justify-content-center align-items-center vh-100">
            ...
            <div className="card login-card shadow-lg border-0">
                <div className="row g-0">
                    ...
                    <div className="col-md-6 d-flex align-items-center justify-content-center" style={{ backgroundColor: '#F75409' }}>
                        <img src={ferre} className="img-fluid" alt="ferre" style={{ width: '80%' }} />
                    </div>
                    ...
                    <div className="col-md-6 bg-white d-flex flex-column justify-content-center p-4">
                        <form onSubmit={handleSubmit} className="w-100">
                            ...
                            <button type="submit" className="btn btn-primary w-100" id="btn_login">
                                Iniciar Sesión
                            </button>
                        </form>
                    </div>
